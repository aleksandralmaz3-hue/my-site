...
function setPayUIStrings(lang) {
  const t = {
    ru: {
      brand: "Оплата услуги",
      cardTitle: "НОМЕР КАРТЫ",
      help: "Как оплатить услугу (3 грн):",
      steps: [
        "Для активации объявления внесите 3 грн на карту, указанную выше.",
        "Подтвердите оплату кнопкой «Оплачено».",
        "Вернитесь к объявлению кнопкой «Назад».",
        "Когда кнопка «Оплачено» загорится зелёным — ваше объявление готово к публикации.",
      ],
      payBtn: "Оплатить",
      backBtn: "Назад",
    },
